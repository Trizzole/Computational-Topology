...
# I.1 Graphs - Connected Components
...
in the unit interval for which $\gamma(s) = \gamma(t)$

  + If there are no self intersections, then the function is injective and the path is
*simple*
...
- We prevent this by always linking the smaller
...
- To improve the efficiency even more, we
compress paths whenever we traverse them

- We also assume that roots are
...
- Eventually, $\alpha(n)$ goes to infinity, but to reach even beyond five, we need an
...
# I.2 Graphs - Curves in the Plane


# I.3 Graphs - Knots & Links

# I.4 Graphs - Planar Graphs
