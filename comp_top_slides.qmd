...
3. if $U_i$ is open $\forall i$ in some possibly infinite, possibly
     uncountable, index set, then $\bigcup\limits_{i\in I} U_i$ is open
:::
...
:::{.fragment}
- Know open intervals form basis for topology of $\mathbb R$
:::

:::{.fragment}
- Intersections $(a, b) \cap [0, 1]$ form basis of subspace topology of the closed interval
:::
